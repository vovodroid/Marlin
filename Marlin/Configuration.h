...
#define CUSTOM_MACHINE_NAME "0508-pins-ignm-out-dbg"
 ...
 */
  ...
  #define MPC_HEATER_POWER { 22.5*2.15 /*48.375*/ }   // (W) Nominal heat cartridge powers.
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 8.8f }            // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.676f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.095f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.115 }   // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  72.1
  #define DEFAULT_BED_KI  6.82
  #define DEFAULT_BED_KD 507.3
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 195, 200, 25, 50 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 2000, 100, 10000 }
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1.0, 20 } // ...or, set your own edit limits
  #endif
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 375
    ...
    #define FILAMENT_MOTION_SENSOR
      ...
      #define FILAMENT_SWITCH_AND_MOTION        // Define separate pins below to sense motion
        ...
        #define FILAMENT_MOTION_DISTANCE_MM 3.7 // (mm) Missing distance required to trigger runout

        #define NUM_MOTION_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_MOTION#_PIN for each.
        #define FIL_MOTION1_PIN    PA0          // FIL_RUNOUT2_PIN, E1DET
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 5), (Y_MAX_POS - 10), 0 }
