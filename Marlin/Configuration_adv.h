...
#define FT_MOTION
  ...
  #define FTM_FS                    10000         // (Hz) Frequency for trajectory generation. (Reciprocal of FTM_TS)
  #define FTM_TS                     (1.f/FTM_FS) // (s) Time step for trajectory generation. (Reciprocal of FTM_FS)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 8*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_HEAT_BED_RAISE            0 //(°C) Raise bed temperature by this value to improve adhesion after restart (limited by maximum allowed temerature).
    ...
    #define POWER_LOSS_STATE            LOW // 1.9V State of pin indicating power loss 
    ...
    #define BACKUP_POWER_SUPPLY           // Backup power / UPS to move the steppers on power-loss
      ...
      #define POWER_LOSS_RETRACT_LEN     2  // (mm) Length of filament to retract on fail
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.01, 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME       0.05  // (mm) Extra distance to prime nozzle after returning from park.
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
    ...
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX     21        // (mm^3/sec)
  #endif
#endif
