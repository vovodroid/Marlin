...
#define INPUT_SHAPING_Y
  ...
  #endif
  #define SHAPING_MIN_FREQ     1        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_HEAT_BED_RAISE            5 //(°C) Raise bed temperature by this value to improve adhesion after restart (limited by maximum allowed temerature).
    #define PLR_BED_THRESHOLD            70 // (°C) Skip user confirmation at or above this bed temperature (0 to disable)
 ...
 */
    ...
    #define PROBING_MARGIN_LEFT (X_MIN_POS + NOZZLE_TO_PROBE_X_OFFSET)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     6  // (mm) Slow length, to allow time to insert material.
 ...
 */
  ...
  #define DIAG_JUMPERS_REMOVED //Prevent "Motherboard DIAG jumpers must be removed when SENSORLESS_HOMING is disabled" warning
